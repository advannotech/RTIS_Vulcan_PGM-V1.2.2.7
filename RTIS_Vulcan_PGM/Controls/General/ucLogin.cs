                ...
                if (login != string.Empty)
                {
                    switch (login.Split('*')[0])
                    {
                        case "1":
                            ...
                            string permissions = Client.GetPGMPerms(login);
                            if (permissions != string.Empty)
                            {
                                switch (permissions.Split('*')[0])
                                {
                                    case "1":
                                        ...
                                        GlobalVars.userPerms = allPermissions;
                                    ...
                                    default:
                                        ...
                                        errInfo = "Unexpected error while logging in" + Environment.NewLine + "Data Returned:" + Environment.NewLine + permissions;
